...
export default function RegisterForm({
  ...
  setOpenSnackbar: (type: "error" | "success" | "warning", message: { title: string; description: string }) => void;
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setOpenSnackbar("error", {
        title: "Error de registro",
        description: (err as Error).message || "No se pudo registrar el usuario",
      });
    } finally {
      setLoading(false);
    }
