          ...
          {user?.userType?.name === "Profesor" && (
            <>
              <li>
                <button
                  className={styles.listItem}
                  onClick={() => handleNavigation("/dashboard/clases")}
                >
                  <svg
                    className={styles.icon}
                    width="20"
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    strokeWidth="2"
                  >
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.89 12 19.79 19.79 0 0 1 1.21 3.59 2 2 0 0 1 3.22 1.4h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
              ...
              <li>
                <button
                  className={styles.listItem}
                  onClick={() => handleNavigation("/dashboard/my-events")}
                >
                  <svg
                    className={styles.icon}
                    width="20"
